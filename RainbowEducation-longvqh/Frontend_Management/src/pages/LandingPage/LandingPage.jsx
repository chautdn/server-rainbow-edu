        ...
        <main className="min-h-screen">
                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        <div className="md:w-1/2 mb-8 md:mb-0 justify-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button className="bg-white text-indigo-900 px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition">
                    ...
                    <div className="flex justify-center items-center space-x-4 mb-6">
                        {ageGroups.map((age) => (
                            <button
                                ...
                                className={`w-8 h-8 rounded-full border-2 border-indigo-600 font-medium transition ${selectedAge === age
                        ...
                        <div className="flex border border-indigo-600 rounded-full overflow-hidden text-sm">
                            <button
                                ...
                                className={`px-3 py-1 transition ${language === "vi" ? "bg-indigo-900 text-white" : "text-indigo-600"
                                    }`}
                            >
                                Tiếng Việt
                            </button>
                            <button
                                ...
                                className={`px-3 py-1 transition ${language === "en" ? "bg-indigo-900 text-white" : "text-indigo-600"
                                    }`}
                            >
                                Tiếng Anh
                            </button>
                    ...
                    <div className="flex justify-center mb-6">
                        <div className="flex border border-indigo-900 rounded-full overflow-hidden">
                            <button
                                ...
                                className={`px-6 py-2 font-semibold transition ${activeTab === "game"
                                    ? "bg-indigo-900 text-white"
                            ...
                            <button
                                ...
                                className={`px-6 py-2 font-semibold transition ${activeTab === "lesson"
                                    ? "bg-indigo-900 text-white"
                                    : "text-indigo-900 hover:bg-indigo-100"
                                    }`}
                            >
                ...
                <div className="container mx-auto px-4 justify-center">
                    <div className="flex flex-col md:flex-row">
                        <div className="justify-center md:w-1/2  ">
                            <img src="../../../public/img/Frame 1.png" alt="Learning process" className="rounded-lg w-md items-center " />
                        </div>
                        <div className="flex flex-col text-left justify-end text-black font-bold md:w-1/2 mt-8 md:mt-0">
                            ...
                            <p className=" mb-4">
                                Khi trẻ khám phá những thế giới mới và kết bạn với các sinh vật kỳ diệu, chúng học được nhiều cách khác nhau để giải quyết vấn đề.
                            </p>
                            <p className=" mb-4">
                                Không có giới hạn thời gian hay áp lực phải tiến bộ nhanh, trò chơi của chúng tôi mang đến một không gian an toàn để trẻ tự do khám phá và học hỏi từ những sai lầm.
                            </p>
                            <p className=" mb-4">
                                Dù là để luyện tập thêm hay thử thách thú vị, trò chơi của Rainbow-learn luôn mang lại kết quả học tập thực sự!
                            </p>
                            <p className="mb-4">
                                Trẻ chơi Rainbow-learn hơn 4 lần mỗi tuần có mức độ cải thiện lên đến 75% chỉ trong 2 tháng đầu tiên. 🚀
                            </p>
                        </div>
            ...
            <section className="py-16 bg-indigo-900 text-white relative">
                ...
                <div className="container mx-auto px-4 py-16 relative z-10">
                    <h2 className="text-2xl md:text-3xl font-bold text-center mb-12">Mỗi Ngày Một Điều mới</h2>
                ...
                <div className="absolute bottom-0 w-full">
                    <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'translateY(1px)' }}>
                        <path
            ...
            <section className="py-16 text-black relative">
                <div className="container mx-auto px-4 py-16 relative z-10">
                    <h2 className="text-2xl md:text-3xl font-bold text-center mb-12">Thử ngay RAINBOW miễn phí!</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className='cold-span-1 space-y-6'>
                            <img src="../../../public/img/image 4.png" alt="Benefits" className="rounded-lg w-md" />
                        </div>
                    </div>
                </div>
            </section>
